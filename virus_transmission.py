...
def calculate_infections(starting_number_infections, reproduction_rate, num_days):
    ...
    """
    new_number_infections = starting_number_infections
    for _ in range(num_days):
        additional_rate = reproduction_rate - 1
        new_number_infections *= (1 + additional_rate)
    
    return round(new_number_infections)
